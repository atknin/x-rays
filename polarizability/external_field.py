...
def compute(request):
	...
	betaprmtr = betaprmtr_0 + d14 * math.pow( math.sin(betaprmtr_0),2) / (1+d14*math.sin(betaprmtr_0))# угол бета решетки
	gammaprmtr =gammaprmtr_0 + ( (d12 * math.cos( gammaprmtr_0 )* math.sin( gammaprmtr_0 )) / math.sqrt( (2*d12+math.pow(d12,2) )*math.pow(math.sin( gammaprmtr_0 ),2) + 1) )# угол гамма решетки
...
# Собственная кривая кристалла -–––––––––––––––––––––––––––––––––––
	...
	message['StructFactor0'] = str(StructFactor0)
	message['StructFactorReal'] = str(StructFactorReal)
	message['StructFactorImag'] = str(StructFactorImag)
