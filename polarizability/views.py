...
# Собственная кривая кристалла -–––––––––––––––––––––––––––––––––––
		...
		dTeta = sdvig*math.pi/180/3600 - 3*delta*math.pi/180/3600
		dTeta_end = sdvig*math.pi/180/3600 + 3*delta*math.pi/180/3600
		...
		From_ = min_rasst_ot_centra_which_point - 2*point_for_curve
		To_ = min_rasst_ot_centra_which_point + 2*point_for_curve
